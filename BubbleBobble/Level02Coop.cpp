...
Level02Coop::Level02Coop(const std::string& name, int windowScale)
	: Scene(name)
...
void Level02Coop::AddLevel02Layout()
{
...
void Level02Coop::AddLevelCollision()
{
	auto go = std::make_shared<Engine::GameObject>();
